...
from app.api.schemas import ChatCreateOut, ChatOut
...
def list_chats(db: DbDep, current_user: CurrentUserDep) -> list[ChatOut]:
    rows = db.scalars(
...
def create_chat(db: DbDep, current_user: CurrentUserDep) -> ChatCreateOut:
